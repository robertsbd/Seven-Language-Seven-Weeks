...
maze(1,1,1). maze(2,1,1). maze(3,1,-1). maze(4,1,1). maze(5,1,1). maze(6, 1, 1).
...
solve_maze(Previous, From, To) :-
    ...
    write(Intermediate), nl. % at the moment writes the result backwards and doesn't include the start and end. Need to Unify the solution.